...
p1xy = vector(-STARTLOCATION, 0)
p1aim = vector(SPEED, 0)
p1body = set()

p2xy = vector(STARTLOCATION, 0)
p2aim = vector(-SPEED, 0)
p2body = set()
...
def inside(head):
    ...
    #size is 200
    playSize = 200
    return -playSize < head.x < playSize and -playSize < head.y < playSize
